      ...
      <div className="container">
        <div className="flex items-center justify-between">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            <Link href="/" className="text-xl font-medium text-foreground flex items-center">
              <span className="text-primary font-bold">Talen</span>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            >
              ...
              <Link
                ...
                className={cn(
                  "text-sm transition-colors relative group",
                  activeSection === "benefits" ? "text-primary" : "text-muted-foreground hover:text-foreground",
                )}
            ...
            >
              <ThemeToggle />
              <Button asChild variant="gradient" size="sm" className="rounded-full px-5 py-2 btn-modern">
        ...
        {isOpen && (
          ...
          >
            <div className="container py-6 space-y-6">
              ...
              <Button asChild variant="gradient" className="w-full rounded-full py-6 btn-modern">
                <Link href="#contact" onClick={() => handleNavClick("contact")}>
                  Get Demo
                </Link>
              </Button>
