    ...
    >
      ...
      <div className="container">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between">
          ...
          >
            <Link href="/" className="text-xl font-bold text-foreground group">
              <span className="text-primary group-hover:text-primary/80 transition-colors">Talen</span>
              <span className="group-hover:text-primary/80 transition-colors">Dojo</span>
            </Link>
          </motion.div>
        ...
        <div className="mt-8 pt-8 border-t border-border/50 text-center">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} TalenDojo. All rights reserved.</p>
        </div>
      </div>
    </motion.footer>
  )
