  ...
  if (submitted) {
    return (
      ...
      >
        ...
        >
          We've received your request and will send you a personalized demo link shortly. One of our team members will
    ...
    >
      ...
      <div className="flex items-center gap-4 pt-2">
        ...
        <p className="text-sm text-muted-foreground">
          <span className="font-medium text-foreground">Quick setup</span> - Get your demo within 24 hours
        </p>
      </div>
    </motion.form>
  )
