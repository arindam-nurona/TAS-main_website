...
const benefits = [
  ...
  },
  {
    ...
    description: "Evaluate candidates based on actual skills and problem-solving abilities, not just resume keywords.",
    icon: <CheckCircle2 className="h-6 w-6 text-primary" />,
  },
  {
  ...
  },
  {
    ...
    description: "Screen 10x more candidates without increasing your recruiting team's workload.",
    icon: <CheckCircle2 className="h-6 w-6 text-primary" />,
  },
]
    ...
    <section id="benefits" className="section-spacing relative overflow-hidden">
      ...
      <div ref={ref} className="container relative">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          ...
          >
            Join forward-thinking companies that are already saving time and making better hiring decisions
          </motion.p>
        </div>
        ...
        >
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            No credit card required. See how TalenDojo can transform your hiring process.
          </p>
        </motion.div>
      </div>
    </section>
